...
<head>
 ...
 <script type="text/javascript" src="Vista/jquery/jquery-codigo-min.js"></script>
...
Consultorio---</option>
 <option value="101"> Laboratorio de sangre</option>
 <option value="102"> Radiografias</option>
 </select>
 </td>
 </tr>
 <tr>
